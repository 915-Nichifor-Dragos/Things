...
public class UserLogic : IUserLogic
{
    ...
    public async Task<bool> UpdateUserInfo(string username, MyAccountDetailsViewModel newUserDetails, string host, int port)
    {
        ...
        AccountDetailsMapper.MapAccountDetailsToUser(user, newUserDetails);
        _userRepository.Update(user);
